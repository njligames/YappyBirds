...
function Gameplay:onMessage(message)
  ...
  print("Gameplay:onMessage(message)")
end
...
function Gameplay:touchDown(touches)
  ...
  print("Gameplay:touchDown(touches)")
end

function Gameplay:touchUp(touches)
  BaseClass.touchUp(self, touches)
  print("Gameplay:touchUp(touches)")
end

function Gameplay:touchMove(touches)
  BaseClass.touchMove(self, touches)
  print("Gameplay:touchMove(touches)")
end

function Gameplay:touchCancelled(touches)
  BaseClass.touchCancelled(self, touches)
  print("Gameplay:touchCancelled(touches)")
end
...
function Gameplay:keyboardShow()
  ...
  print("Gameplay:keyboardShow()")
end

function Gameplay:keyboardCancel()
  BaseClass.keyboardCancel(self)
  print("Gameplay:keyboardCancel()")
end

function Gameplay:keyboardReturn(text)
  BaseClass.keyboardReturn(self, text)
  print("Gameplay:keyboardReturn(text)")
end
...
function Gameplay:hash()
    return "YAPPYBIRDS.WORLDS.YAPPYBIRDS.STATES.Gameplay"
end
