...
font = njli.World.getInstance():getWorldHUD():createFont("sans-ch", "fonts/DroidSansJapanese.ttf")
if (font == -1) then
    print("Could not add font italic.\n");
else
	print("yes " .. font)
...
font = njli.World.getInstance():getWorldHUD():createFont("sans-ko", "fonts/malgun.ttf")
if (font == -1) then
    print("Could not add font italic.\n");
else
	print("yes " .. font)
